...
class Command(BaseCommand):
    ...
    CSV_FILE_NAMES_COMMAND = (
        ('loadcats', 'category.csv'),
        ('loadgenres', 'genre.csv'),
        ('loadtitles', 'titles.csv'),
        ('loadgenretitle', 'genre_title.csv'),
        ('loadusers', 'users.csv'),
        ('loadreviews', 'review.csv'),
        ('loadcomments', 'comments.csv')
    )
    ...
    help = 'Загружает данные по всем моделям.'
